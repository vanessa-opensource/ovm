...
Сценарий: Установка версии
    Когда Я выполняю команду "ovm" c параметрами "install stable"
...
Сценарий: Использование версии
    Допустим Я выполняю команду "ovm" c параметрами "install stable"
    Когда Я выполняю команду "ovm" c параметрами "use stable"
