...
Процедура УстановитьOneScript(Знач ВерсияКУстановке)
	...
	Команда = ПолучитьКомандуУстановкиOneScript(ФайлУстановщика, КаталогУстановкиВерсии);
	Команда.Исполнить();
...
Функция СкачатьФайлУстановщика(Знач ВерсияКУстановке)
	...
	Если ЭтоWindows Тогда
		...
		Ресурс = СтрШаблон("downloads/%1/OneScript-%2-setup.exe", СтрЗаменить(ВерсияКУстановке, ".", "_"), ВерсияКУстановке);
